...
def extract_features(list_images, label):
    ...
    with tf.Session() as sess:
        ...
        for ind, image in enumerate(list_images):
            ...
            print('Extracting features from image' + ind)
...
X_train= np.concatenate((features_1[:30],features_2[:30],features_3[:30],features_4[:30], features_5[:30], features_6[:30], features_7[:30], features_8[:30], features_9[:50]),axis=0)
y_train= np.concatenate((labels_1[:30],labels_2[:30],labels_3[:30],labels_4[:30], labels_5[:30], labels_6[:30], labels_7[:30], labels_8[:30], labels_9[:50]), axis=0)


X_test= np.concatenate((features_1[30:],features_2[30:],features_3[30:],features_4[30:], features_5[30:], features_6[30:], features_7[30:], features_8[30:], features_9[50:]),axis=0)
y_test= np.concatenate((labels_1[30:],labels_2[30:],labels_3[30:],labels_4[30:], labels_5[30:], labels_6[30:], labels_7[30:], labels_8[30:], labels_9[50:]), axis=0)
